...
export namespace roleUpgraderLevel3 {
  ...
  export function handleAutoBuild(): boolean {
    ...
    if (upgrader.length < Memory.maxUpgraderLevel3CreepsAmount) {
      return build();
    }
    return false;
  }
  ...
  export function build(): boolean {
    ...
    return buildCreep(roleName,
      [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY]
    );
  }
